...
export declare class Recipe extends PlusObject {
    /**
     * Get recipe from given recipe ID
     * @param recipeId UUID of the recipe
     */
    getRecipeFromId(recipeId: string, additionalRequestOptions?: AdditionalRequestOptions): Promise<RecipeModel>;
    /**
...
export declare enum RecipeCookingTime {
