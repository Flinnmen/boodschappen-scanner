...
export declare class Recipe extends CoopObject {
    /**
     ...
     */
    getIngredientsFromRecipe(recipeId: number, options?: SingleRecipeOptions, additionalRequestOptions?: AdditionalRequestOptions): Promise<RecipeIngredientModel[]>;
    /**
     ...
     */
    getRecipesFromName(recipeName: string, options?: RecipeOptions, additionalRequestOptions?: AdditionalRequestOptions): Promise<RecipeQueryModel>;
}
export declare enum RecipeSortOptions {
    Relevant = "",
